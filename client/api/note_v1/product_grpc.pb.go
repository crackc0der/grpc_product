...
const (
	Product_GetProduct_FullMethodName     = "/client.Product/GetProduct"
	Product_GetAllProducts_FullMethodName = "/client.Product/GetAllProducts"
)
...
type ProductClient interface {
	...
	GetAllProducts(ctx context.Context, in *AllProductRequest, opts ...grpc.CallOption) (*AllProductMessage, error)
}
...
func (c *productClient) GetAllProducts(ctx context.Context, in *AllProductRequest, opts ...grpc.CallOption) (*AllProductMessage, error) {
...
type ProductServer interface {
	...
	GetAllProducts(context.Context, *AllProductRequest) (*AllProductMessage, error)
...
func (UnimplementedProductServer) GetAllProducts(context.Context, *AllProductRequest) (*AllProductMessage, error) {
...
func _Product_GetAllProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServer).GetAllProducts(ctx, req.(*AllProductRequest))
	}
	return interceptor(ctx, in, info, handler)
}
